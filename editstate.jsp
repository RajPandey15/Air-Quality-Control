            ...
            <div class="content-page">
                <div class="content">
					...
					<%@taglib uri ="http://www.springframework.org/tags/form" prefix="f" %>
                                    ...
                                    <f:form action="updateState" method="get" modelAttribute="ss">
                                        
                                        
                                        <div class="form-group">
                                            <label>State</label>
                                            <div>
                                                <f:input data-parsley-type="alphanum" type="text" path="stateName"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <f:textarea path="stateDescription" required="required" class="form-control"></f:textarea>
                                            </div>
                                        </div>
