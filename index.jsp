...
<html lang="en">
    <head>
        ...
        <!-- Plugins css -->
        <link href="adminResources/css/flatpickr.min.css" rel="stylesheet" type="text/css" />
    ...
    <body>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless table-hover table-centered m-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="width: 36px;">
                                                        <img src="adminResources/image/user-2.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                                    </td>
                                                ...
                                                <tr>
                                                    <td style="width: 36px;">
                                                        <img src="adminResources/image/user-3.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                                    </td>
                                                ...
                                                <tr>
                                                    <td style="width: 36px;">
                                                        <img src="adminResources/image/user-4.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                                    </td>
                                                ...
                                                <tr>
                                                    <td style="width: 36px;">
                                                        <img src="adminResources/image/user-5.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                                    </td>
                                                ...
                                                <tr>
                                                    <td style="width: 36px;">
                                                        <img src="adminResources/image/user-6.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                                    </td>
        ...
        <script src="adminResources/js/jquery.knob.min.js"></script>
        <script src="adminResources/js/jquery.sparkline.min.js"></script>
        <script src="adminResources/js/jquery.flot.js"></script>
        <script src="adminResources/js/jquery.flot.time.js"></script>
        ...
        <script src="adminResources/js/jquery.flot.crosshair.js"></script>

        <!-- Dashboar 1 init js-->
        <script src="adminResources/js/dashboard-1.init.js"></script>
