                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="check">Add State</a>
                                    </li>
                                    <li>
                                        <a href="view">View State</a>
                                    </li>
                                    <!-- <li>
...
<li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="adddatasets.jsp">Add Datasets</a>
                                    </li>
                                    <li>
                                        <a href="viewdatasets.jsp">View Datasets</a>
                                    </li>
                                    <!-- <li>
                            ...
                            <!-- <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="ecommerce-dashboard.html">Air Pollution</a>
                                    </li>
                                    <li>
                                        <a href="ecommerce-products.html">Air Quality</a>
                                    </li>
                                    <li>
 ...
 -->
                            ...
                            <!-- <li>
                                <a href="managenotifications.jsp">
                                    <i class="fe-mail"></i>
