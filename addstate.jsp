            ...
            <div class="content-page">
                <div class="content">
					...
					<%@taglib prefix="s" uri="http://www.springframework.org/tags/form"%>
                                    ...
                                    <s:form action="check" modelAttribute="x" class="parsley-examples" method="GET">
                                        
                                        
                                        <div class="form-group">
                                            <label>State</label>
                                            <div>
                                                <s:input data-parsley-type="alphanum" type="text" path="stateName"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <s:textarea path="stateDescription" required="required" class="form-control"></s:textarea>
                                            </div>
                                        </div>
