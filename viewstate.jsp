...
<html lang="en">
    <head>
        ...
        <!-- third party css -->
        <link href="adminResources/css/dataTables.bootstrap4.css" rel="stylesheet" type="text/css" />
        <link href="adminResources/css/responsive.bootstrap4.css" rel="stylesheet" type="text/css" />
        <link href="adminResources/css/buttons.bootstrap4.css" rel="stylesheet" type="text/css" />
        <link href="adminResources/css/select.bootstrap4.css" rel="stylesheet" type="text/css" />
        <!-- third party css end -->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted font-13 mb-4">
                                            ...
                                            function:
                                            <code>$().DataTable();</code>. -->
                                            Details about the states added.
                                        </p>
                                      ...
                                      <c:forEach items="${entry}" var="x">
												...
												<tr>
													<td>${x.id}</td>
													<td>${x.stateName}</td>
													<td>${x.stateDescription}</td>
													<td><a href="delete?id=${x.id}">delete</a>
													<a href="editdata?id=${x.id}">edit</a></td>
												</tr>
										</c:forEach>
