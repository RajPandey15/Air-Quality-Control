                        ...
                        <div class="row">
                                ...
                                <div class="card-box">
                                    ...
                                    <p class="text-muted font-14 m-b-20">
                                        India is a federal union comprising 29 states and 7 union territories, for a total of 36 entities. The states and union territories are further subdivided into districts and smaller administrative divisions. Select a State in which the City you want to add exists.
                                    </p>


					<%@taglib prefix="f" uri ="http://www.springframework.org/tags/form"  %>
					<%@taglib prefix="c" uri ="http://java.sun.com/jstl/core_rt"%>
                                    <f:form action="insertCity" class="parsley-examples">
                                        
                                        
                                        <div class="form-group">
                                            <label>State</label>
                                            <div>
                                               <f:select path="registervo.id">
                                        ...
                                        <div class="form-group">
                                            <label>City</label>
                                            <div>
                                                <f:input data-parsley-type="alphanum" type="text" path="cityName"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <f:textarea path="cityDescription" required="required" class="form-control"></f:textarea>
                                            </div>
                                        </div>
